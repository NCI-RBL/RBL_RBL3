...
#Run pipeline on cluster or locally
  ...
  files_save=("${output_dir}/snakemake_config.yaml" "${output_dir}/cluster_config.yml" ${config_DEGManifest} ${config_sampleManifest} 'workflow/Snakefile' 'workflow/scripts/create_error_report.sh')
