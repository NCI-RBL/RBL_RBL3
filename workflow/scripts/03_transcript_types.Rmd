...
params:
  f_talon_data: 
    value: "~/../../Volumes/sevillas2/rbl3_test3/05_talon/counts/SIRV_talon_abundance_filtered.tsv"
  u_talon_data: 
    value: "~/../../Volumes/sevillas2/rbl3_test3/05_talon/counts/SIRV_talon_abundance.tsv"
  u_flair_data: 
    value: "~/../../Volumes/sevillas2/rbl3_test3/06_flair/counts/flair_counts_matrix.tsv"
  output_dir:
    value: "~/../../Volumes/sevillas2/rbl3_test3/08_report"
  log_dir:
    value: "~/../../Volumes/sevillas2/rbl3_test3/log"
  perc_sim:
    value: 20
  num_match:
    value: 5
  ...
  clean_up:
    value: "Y"
  deg_list:
    value: "~/../../Volumes/sevillas2/rbl3_test3/07_deg/deg_iso_wt_ko.dicer.txt ~/../../Volumes/sevillas2/rbl3_test3/07_deg/deg_iso_wt_ko.drosha.txt"
editor_options: 
