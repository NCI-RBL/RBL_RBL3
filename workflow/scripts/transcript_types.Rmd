...
```{r}
#plot unfiltered
TranscriptFeatures(unfiltered_data,"    Unfiltered Data","unfiltered_abundance")
```
...
```{r}
TranscriptFeatures(filtered_data,"     Filtered Data","filtered_abundance")
```
